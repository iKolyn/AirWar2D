import { _decorator, CCInteger, Component, Node, NodePool, RigidBody, Prefab, instantiate, math, view, UITransform, Collider2D } from 'cc';
...
export class RewardManager extends Component {
    ...
    unuseReward(reward:Node,type:number){
        ...
        console.log(this.rewardPool[type].size());
    }
